...
export default function TeamsButton({ iconAlt }: { iconAlt: string }) {
  return (
    <a
      ...
      target="_blank"
      className="px-8 sm:px-10 py-3 sm:py-4 w-fit bg-gradient-to-br from-[#1c1f4a] to-[#7B83EB] text-white text-lg md:text-xl 3xl:text-2xl font-outfit font-semibold rounded-xl flex gap-6 items-center transition-transform hover:scale-105 active:scale-110"
    >
